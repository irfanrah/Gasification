...
def my_mainloop():
	Motor = ArduRead()
	Tk.Label(master=root, text=Motor[0],font=("Helvetica", 25)).place(x = 50, y = 520)
	Tk.Label(master=root, text=Motor[1],font=("Helvetica", 25)).place(x = 250, y = 520)
	Tk.Label(master=root, text=Motor[2],font=("Helvetica", 25)).place(x = 480, y = 520)
	Tk.Label(master=root, text=Motor[3],font=("Helvetica", 25)).place(x = 700, y = 520)
